...
def parse_patchdata(data):
    ...
    if patch_struct is minilogue_og_patch_struct:
        new_patch = normalise_og_patch(patch)
        # remember to do something with this new patch at some point
...
def translate(filename, name, id, list):
